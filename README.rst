...
This is a python/JAX port of the `original fortran
implementation <https://github.com/JavierEscoto/MONKES>`__. It solves
the drift kinetic equation (DKE) using the monoenergetic approximation,
